 ...
 * Modern design with primary header and pill tabs
 */

import { useState, useEffect } from 'react';
import { useNavigate, useSearchParams } from 'react-router-dom';
import { useTranslation } from 'react-i18next';
import { Inbox, MapPin, Package, Calendar, Mail, Send, CheckCircle, Clock } from 'lucide-react';
...
export function SupplierRFQInbox() {
  ...
  const tabs = [
    { id: 'new', label: t('supplierRFQInbox.tabs.new', 'New'), count: counts.new, hasAlert: counts.new > 0, icon: <Mail size={16} /> },
    { id: 'sent', label: t('supplierRFQInbox.tabs.sent', 'Sent'), count: counts.sent, icon: <Send size={16} /> },
    { id: 'accepted', label: t('supplierRFQInbox.tabs.accepted', 'Won'), count: counts.accepted, icon: <CheckCircle size={16} /> },
    { id: 'expired', label: t('supplierRFQInbox.tabs.expired', 'Expired'), count: counts.expired, icon: <Clock size={16} /> },
  ];
